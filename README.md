...
[![Version](https://img.shields.io/badge/version-2026.2.13-blue.svg)](https://github.com/iyeoh88-svg/openclaw-android)
...
If you see this error after the setup wizard, ignore it and proceed to [Start Up](#start-up).It will still work.
```bash
